...
// Flat Delivery Charge for Demo Template
const DEFAULT_DELIVERY_CHARGE = 60;

/**
 * Rules for delivery eligibility and fees.
 * Simplified to a flat charge for the demo template.
 */
export const getDeliveryConfig = (pincode = "", distance = null) => {
  return { 
    threshold: Infinity, // No free delivery threshold by default
