...
const allowedOrigins = [
  getFrontendOrigin(),
  "https://demomart.com",
  "https://www.demomart.com",
  "http://demomart.com",
  "http://www.demomart.com",
  "https://demomart.vercel.app",
...
const getAllowedScriptOrigins = () => [
  ...
  "https://checkout.demopayment.com"
];
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://accounts.google.com", "https://accounts.googleusercontent.com", "https://checkout.demopayment.com"],
      frameSrc: ["'self'", "https://accounts.google.com", "https://checkout.demopayment.com"],
...
app.get("/api/health", (_req, res) => {
  res.status(200).json({
    success: true,
    message: "demo-mart backend is running",
