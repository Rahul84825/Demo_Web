...
const PAYMENT_METHODS = ["demopayment", "UPI", "CARD", "NETBANKING", "WALLET"];
...
const orderSchema = new mongoose.Schema(
  {
    ...
    payment: {
      ...
      demopaymentOrderId: { type: String, unique: true, sparse: true },
      demopaymentPaymentId: { type: String, unique: true, sparse: true },
      demopaymentSignature: { type: String, default: "" },
...
// Index for DemoPayment payment lookups
orderSchema.index({ "payment.demopaymentOrderId": 1, "payment.demopaymentPaymentId": 1 }, { sparse: true });
