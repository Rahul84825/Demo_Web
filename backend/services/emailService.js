...
const getFromEmail = () => process.env.EMAIL_FROM || "DemoMart <orders@demomart.com>";
const getAdminEmail = () => process.env.ADMIN_EMAIL || "admin@demomart.com";
...
export const sendOrderPlacedEmail = async (order) => {
  ...
  await sendEmailSafely({
    to: customer.email,
    subject: `Order Confirmed! (#${order.orderNumber}) - DemoMart`,
    html
  });
};
...
export const sendOrderAcceptedEmail = async (order) => {
  ...
  await sendEmailSafely({
    to: customer.email,
    subject: `Order Accepted (#${order.orderNumber}) - DemoMart`,
    html
  });
};
...
export const sendOrderPreparingEmail = async (order) => {
  ...
  await sendEmailSafely({
    to: customer.email,
    subject: `Order Preparing (#${order.orderNumber}) - DemoMart`,
    html
  });
};
...
export const sendOrderOutForDeliveryEmail = async (order) => {
  ...
  await sendEmailSafely({
    to: customer.email,
    subject: `Order on the Way! (#${order.orderNumber}) - DemoMart`,
    html
  });
};
...
export const sendOrderDeliveredEmail = async (order) => {
  ...
  await sendEmailSafely({
    to: customer.email,
    subject: `Order Delivered (#${order.orderNumber}) - DemoMart`,
    html
  });
};
...
export const sendOrderRejectedEmail = async (order) => {
  ...
  await sendEmailSafely({
    to: customer.email,
    subject: `Order Update (#${order.orderNumber}) - DemoMart`,
    html
  });
};
...
export const sendPaymentSuccessEmail = async (order) => {
  ...
  await sendEmailSafely({
    to: customer.email,
    subject: `Payment Successful (#${order.orderNumber}) - DemoMart`,
    html
  });
};
...
export const sendPaymentFailedEmail = async (order) => {
  ...
  await sendEmailSafely({
    to: customer.email,
    subject: `Payment Failed (#${order.orderNumber}) - DemoMart`,
    html
  });
};
...
export const sendContactFormCustomerReply = async (inquiry) => {
  ...
  await sendEmailSafely({
    to: inquiry.email,
    subject: `We've received your message - DemoMart`,
    html
  });
};
