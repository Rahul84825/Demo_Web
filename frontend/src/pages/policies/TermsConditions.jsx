  ...
  return (
    <div className="min-h-[60vh] bg-[var(--cream)]">
      <SEO 
        ...
        description="Review the terms and conditions for using DemoMart's website and services."
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose max-w-none space-y-6 text-gray-700">
          <section>
            ...
            <p>
              By accessing and using DemoMart, you accept and agree to be bound by the terms and
          ...
          <section>
            ...
            <p>
              ...
              on DemoMart for personal, non-commercial transitory viewing only. This is the grant of a license,
          ...
          <section>
            ...
            <p>
              The materials on DemoMart are provided on an "as is" basis. DemoMart makes no
          ...
          <section>
            ...
            <p>
              In no event shall DemoMart or its suppliers be liable for any damages (including,
              without limitation, damages for loss of data or profit, or due to business interruption)
              arising out of the use or inability to use the materials on DemoMart.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The materials appearing on DemoMart could include technical, typographical, or
              photographic errors. DemoMart does not warrant that any of the materials on its
          ...
          <section>
            ...
            <p>
              DemoMart has not reviewed all of the sites linked to its website and is not responsible
              for the contents of any such linked site. The inclusion of any link does not imply endorsement
              by DemoMart of the site. Use of any such linked website is at the user's own risk.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              DemoMart may revise these terms of service for its website at any time without notice.
