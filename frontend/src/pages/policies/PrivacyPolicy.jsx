  ...
  return (
    <div className="min-h-[60vh] bg-[var(--cream)]">
      <SEO 
        ...
        description="Read DemoMart's privacy policy to understand how we collect, use, and protect your personal information."
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose max-w-none space-y-6 text-gray-700">
          <section>
            ...
            <p>
              DemoMart ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy
