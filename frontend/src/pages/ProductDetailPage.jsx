...
function ProductDetailPage() {
  ...
  if (loading) return <div className="min-h-[60vh] flex items-center justify-center bg-[var(--cream)] animate-pulse serif text-2xl font-medium">Loading product...</div>;
  ...
  return (
    <div className="page-enter bg-[var(--cream)] min-h-[60vh] pb-20">
      <SEO 
        title={product.name}
        description={product.description?.substring(0, 160) || `Buy premium ${product.name} online at DemoMart. Traditional Indian sweets delivered fresh in Demo City.`}
