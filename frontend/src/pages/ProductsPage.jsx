...
function ProductsPage() {
  ...
  const pageDesc = filters.category
    ? `Browse our premium ${filters.category} collection. Handcrafted with love and delivered fresh across Demo City.`
    : "Explore our complete range of premium Indian sweets, dry fruit product, and traditional treats. Order online for delivery in Demo City.";
      ...
      <SectionContainer>
        <div className="flex flex-col gap-8">
          <div className="section-title mb-0 border-b border-[var(--surface-border)] pb-6">
            ...
            <h1 className="serif text-4xl md:text-5xl">product & Treats</h1>
