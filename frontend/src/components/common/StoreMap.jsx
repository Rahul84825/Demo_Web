...
/**
 * StoreMap Component
 * Reusable Google Maps embed for DemoMart
    ...
    >
      ...
      {showTitle && (
        <div className="absolute top-0 left-0 right-0 z-20 bg-gradient-to-b from-black/60 to-transparent px-6 py-4">
          <h3 className="text-white font-medium text-lg">DemoMart Location</h3>
        </div>
      )}
      ...
      {isVisible && (
        <iframe
          title="DemoMart Store Location on Google Maps"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d945.5354421541357!2d73.91303300857543!3d18.567646224382504!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c19242795771%3A0xf9fafc63a239e3b!2sproduct%20World!5e0!3m2!1sen!2sin!4v1779456306986!5m2!1sen!2sin"
          {...Object.fromEntries(
