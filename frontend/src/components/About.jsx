...
const TIMELINE = [
  {
    year: "2022",
    title: "The Beginning",
    desc: "Demo Owner founded DemoMart in Demo City, Demo City with a passion for authentic Indian sweets and traditional recipes.",
  },
  {
    year: "2023",
    title: "Growing Family",
    desc: "Within our first year, over 2000 families in Demo City trusted us for their celebrations. We expanded our range to include dry fruit products.",
  },
  {
    year: "2024",
    title: "5000+ Happy Homes",
    desc: "Today we proudly serve 5000+ happy customers across Demo City, becoming a household name for premium quality sweets.",
  },
];
  ...
  return (
    <main className="min-h-[60vh] bg-[#fff8f0] font-['Inter',system-ui,sans-serif]">
      <SEO 
        ...
        description="Learn about DemoMart's journey from a local shop in Demo City to serving 5000+ happy families in Demo City with authentic, fresh Indian sweets."
        canonical="/about"
      />
            ...
            <div className="max-w-lg">
              ...
              <div className="space-y-4 text-[13px] leading-relaxed text-[#6e5443]">
                <p>
                  ...
                  <strong className="text-[#24140f]">Demo Owner</strong> with a simple
                  dream — to bring premium quality, authentic Indian sweets to families of Demo City
                  at honest, affordable prices.
                </p>
                <p>
                  Located in the heart of{" "}
                  <strong className="text-[#24140f]">Demo City</strong>,
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_2fr]">
            ...
            <div className="flex flex-col gap-3">
              {[
                { icon: MapPin, label: "Address", value: "DemoMart, Demo Address Line 1, Demo Address Line 2, Demo Address Line 3, Demo City, Demo City, Demo State 000000", href: "https://maps.app.goo.gl/i7VqYRV4YFvNRdTc8" },
