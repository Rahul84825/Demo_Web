...
const SHIPPING_POINTS = [
  {
    ...
    desc: "We provide delivery services within Akurdi, Demo City, and nearby areas in Demo City. For deliveries outside this region, please contact us directly to discuss availability.",
  },
  {
    icon: Clock,
...
const ShippingPolicy = () => (
  <main className="min-h-screen bg-[var(--surface-border)] font-['Inter',system-ui,sans-]">
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="space-y-8 rounded-2xl border border-[rgba(99, 102, 241,0.10)]
        ...
        <div className="space-y-3">
          <p className="text-[13px] leading-relaxed text-[#475569]">
            ...
            customers in Akurdi, Demo City, and surrounding areas in Demo City.
          </p>
          <p className="text-[13px] leading-relaxed text-[#475569]">
          ...
          {SHIPPING_POINTS.map(({ icon: Icon, title, desc }) => (
            <div key={title}
              ...
              <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center
                              rounded-lg bg-[rgba(99, 102, 241,0.10)]">
        ...
        <div className="rounded-xl border border-[rgba(99, 102, 241,0.25)]
          ...
          <h3 className="mb-2 text-sm font-medium text-[#0F172A]">Questions about delivery?</h3>
